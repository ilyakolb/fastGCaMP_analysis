...
for i = 2:length(mutant_hits)
    ...
    figure(dff_fig); hold on, errorbar(nAPs, mutant_dff_mean, mutant_dff_sterr, 'linewidth', 2);
    ...
    SNR = plotMutant.SNR;
    % figure, hist(SNR(8,:))
    figure(SNR_fig); hold on, errorbar(nAPs, mutant_SNR_mean_norm, mutant_SNR_sterr_norm,  'linewidth', 2);
    ...
    figure(halfrise_fig); hold on, errorbar(nAPs, mutant_halfrise_mean_norm, mutant_halfrise_sterr_norm, 'linewidth', 2);
    ...
    figure(halfdecay_fig); hold on, errorbar(nAPs, mutant_halfdecay_mean_norm, mutant_halfdecay_sterr_norm, 'linewidth', 2);
