...
plt.close('all')
num_peaks_to_plot = 20 # 40 # 'all' to plot all
length_to_plot = 200
samples_pre_stim = 10
peak_thresh = 10000
...
all_constructs = [ '10.641', '500.456', '500.688']
all_cell_num = ['001', '002', '003', '004']

# all_constructs = ['500.688']
# all_cell_num = ['001']
...
for construct in all_constructs:
    ...
    for cell_num in all_cell_num:
        ...
        # cell_num = '004'
        filename = construct + '-20msec-Ch1-GCaMP-Ch2-mCh-' +cell_num + '.csv'
        ...
        roi1 = data['#1 ( 1)'].values
        roi2 = data['#2 ( 1)'].values
        roi3 = data['#3 ( 1)'].values
